...
public class MealsUtil {
    public static final List<Meal> MEALS = Arrays.asList(
            new Meal(USER_ID, LocalDateTime.of(2015, Month.MAY, 30, 10, 0), "Завтрак", 500),
            new Meal(USER_ID, LocalDateTime.of(2015, Month.MAY, 30, 13, 0), "Обед", 1000),
            new Meal(USER_ID, LocalDateTime.of(2015, Month.MAY, 30, 20, 0), "Ужин", 500),
            new Meal(ADMIN_ID, LocalDateTime.of(2015, Month.MAY, 31, 10, 0), "Завтрак", 1000),
            new Meal(ADMIN_ID, LocalDateTime.of(2015, Month.MAY, 31, 13, 0), "Обед", 500),
            new Meal(ADMIN_ID, LocalDateTime.of(2015, Month.MAY, 31, 20, 0), "Ужин", 510)
    );
    ...
    public static List<MealWithExceed> getFilteredWithExceeded(Collection<Meal> meals, int caloriesPerDay, LocalDate startDate, LocalDate endDate, LocalTime startTime, LocalTime endTime) {
        return getFilteredWithExceeded(meals, caloriesPerDay,
                meal -> DateTimeUtil.isBetween(meal.getDateTime(), startDate, endDate, startTime, endTime));
    }
